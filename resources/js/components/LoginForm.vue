<template>
    <div>
        <div id="form" style="display:flex;justify-content:center;flex-direction:column;">
            <div>
                <h1>Log in!</h1>
                <label>Email</label>
            ...
            <button @click="logIn(email, password)" style='margin:20px;padding:10px'>log in</button>
            <a style="text-align: center">I don't have an account</a>
        </div>
        <svg version="1.1" class="shadow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" id="blobSvg" style="opacity: 1;width: 600px;height:600px;">
