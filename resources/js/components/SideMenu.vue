            ...
            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                <div class="card card-body" style="width: 200px;height: 400px;">
                    ...
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">My Tasks</a>
                        <hr class="solid">
                    </div>
                    ...
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">Inbox</a>
                        <hr class="solid">
                    </div>
                    ...
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">Reporting</a>
                        <hr class="solid">
                    </div>
                    ...
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">Porfolio</a>
                        <hr class="solid">
                    </div>
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">Goals</a>
                        <hr class="solid">
                    </div>
                    ...
                    <div>
                        ...
                        <a  href="https://www.w3schools.com">Trash</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    export default {
        mounted() {
            console.log('Component mountedsd1.')
        }
    }
</script>
